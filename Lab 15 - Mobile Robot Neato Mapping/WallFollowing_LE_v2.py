...
if __name__ == '__main__':
    ...
    thLateralDistWall = 375
    thCentralDistWall = 675
    thDiagDistWall = 525
    thRangeWall = 20
    ###############################
    ...
    try:
        ...
        while 1:
            ...
            if -1 < centralDist < thCentralDistWall: k1 = 1 - centralDist/thCentralDistWall
				...
				if -1 < diagDist < thDiagDistWall: k1 = 1 - diagDist/thDiagDistWall
				else:
					if -1 < leftDist < thDiagDistWall: 
						k1 = 1- leftDist/thLateralDistWall
						k1 = k1*0.5
					else: k1 = 0
            ...
            leftMotorDist = constWallDist + k1 * maxWallCentralDist - k2 * maxWallLateralDist - k3 * maxWallDiagDist 
            rightMotorDist = constWallDist + k3 * maxWallDiagDist - k1 * maxWallCentralDist + k2 * maxWallLateralDist
